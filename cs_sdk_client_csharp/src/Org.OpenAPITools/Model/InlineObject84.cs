...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineObject84 :  IEquatable<InlineObject84>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject84" /> class.
        /// </summary>
        /// <param name="statusId">statusId.</param>
        /// <param name="all">all.</param>
        /// <param name="documentIds">documentIds.</param>
        /// <param name="noDocumentIds">noDocumentIds.</param>
        public InlineObject84(int? statusId = default(int?), bool all = default(bool), List<int> documentIds = default(List<int>), List<int> noDocumentIds = default(List<int>))
        {
        ...
        {
            return this.Equals(input as InlineObject84);
        }

        /// <summary>
        /// Returns true if InlineObject84 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineObject84 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineObject84 input)
        {
            if (input == null)
                return false;
