...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineObject76 :  IEquatable<InlineObject76>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject76" /> class.
        /// </summary>
        ...
        public InlineObject76(int? assigneeId = default(int?), bool all = default(bool), List<int> annotationIds = default(List<int>), List<int> noAnnotationIds = default(List<int>))
        {
        ...
        {
            return this.Equals(input as InlineObject76);
        }

        /// <summary>
        /// Returns true if InlineObject76 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineObject76 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineObject76 input)
        {
            if (input == null)
                return false;
