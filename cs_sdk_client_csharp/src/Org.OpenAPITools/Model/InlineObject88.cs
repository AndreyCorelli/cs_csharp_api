...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineObject88 :  IEquatable<InlineObject88>, IValidatableObject
    {
        /// <summary>
        /// Defines ClusterBy
        /// </summary>
        ...
        {
            return this.Equals(input as InlineObject88);
        }

        /// <summary>
        /// Returns true if InlineObject88 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineObject88 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineObject88 input)
        {
            if (input == null)
                return false;
