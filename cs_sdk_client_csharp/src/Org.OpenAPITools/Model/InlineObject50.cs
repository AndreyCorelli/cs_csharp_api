...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject50 :  IEquatable<InlineObject50>, IValidatableObject
    {
        ...
        public InlineObject50(int document = default(int), string field = default(string), Object value = default(Object), int? locationStart = default(int?), int? locationEnd = default(int?), string locationText = default(string), int? modifiedBy = default(int?))
        {
            // to ensure "document" is required (not null)
            if (document == null)
            {
                throw new InvalidDataException("document is a required property for InlineObject50 and cannot be null");
            }
            else
            {
            ...
            if (field == null)
            {
                throw new InvalidDataException("field is a required property for InlineObject50 and cannot be null");
            }
            else
            {
                this.Field = field;
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for InlineObject50 and cannot be null");
            }
            else
            {
                this.Value = value;
            ...
            {
                throw new InvalidDataException("locationStart is a required property for InlineObject50 and cannot be null");
            }
            else
            {
            ...
            if (locationEnd == null)
            {
                throw new InvalidDataException("locationEnd is a required property for InlineObject50 and cannot be null");
            }
            else
            {
