...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject48 :  IEquatable<InlineObject48>, IValidatableObject
    {
        ...
        public InlineObject48(string name = default(string), string code = default(string), int order = default(int), bool isActive = default(bool), bool isAccepted = default(bool), bool isRejected = default(bool))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for InlineObject48 and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (order == null)
            {
                throw new InvalidDataException("order is a required property for InlineObject48 and cannot be null");
            }
            else
            {
                this.Order = order;
