...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineObject69 :  IEquatable<InlineObject69>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject69" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineObject69() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject69" /> class.
        /// </summary>
        ...
        public InlineObject69(string newPassword1 = default(string), string newPassword2 = default(string), string uid = default(string), string token = default(string))
        {
            // to ensure "newPassword1" is required (not null)
            if (newPassword1 == null)
            {
                throw new InvalidDataException("newPassword1 is a required property for InlineObject69 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("newPassword2 is a required property for InlineObject69 and cannot be null");
            }
            else
            {
            ...
            if (uid == null)
            {
                throw new InvalidDataException("uid is a required property for InlineObject69 and cannot be null");
            }
            else
            {
                this.Uid = uid;
            ...
            if (token == null)
            {
                throw new InvalidDataException("token is a required property for InlineObject69 and cannot be null");
            }
            else
            {
                this.Token = token;
        ...
        {
            return this.Equals(input as InlineObject69);
        }

        /// <summary>
        /// Returns true if InlineObject69 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineObject69 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineObject69 input)
        {
            if (input == null)
                return false;
