...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject13 :  IEquatable<InlineObject13>, IValidatableObject
    {
        ...
        public InlineObject13(string name = default(string), string code = default(string), int order = default(int), bool isActive = default(bool))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for InlineObject13 and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (order == null)
            {
                throw new InvalidDataException("order is a required property for InlineObject13 and cannot be null");
            }
            else
            {
                this.Order = order;
