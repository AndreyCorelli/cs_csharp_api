...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineObject66 :  IEquatable<InlineObject66>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject66" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineObject66() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject66" /> class.
        /// </summary>
        ...
        public InlineObject66(string name = default(string), string code = default(string), int order = default(int), bool isAdmin = default(bool), bool isTopManager = default(bool), bool isManager = default(bool))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for InlineObject66 and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for InlineObject66 and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (order == null)
            {
                throw new InvalidDataException("order is a required property for InlineObject66 and cannot be null");
            }
            else
            {
                this.Order = order;
        ...
        {
            return this.Equals(input as InlineObject66);
        }

        /// <summary>
        /// Returns true if InlineObject66 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineObject66 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineObject66 input)
        {
            if (input == null)
                return false;
