...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject4 :  IEquatable<InlineObject4>, IValidatableObject
    {
        ...
        public InlineObject4(string description = default(string), List<int> documents = default(List<int>), List<int> completedDocuments = default(List<int>), List<int> reviewers = default(List<int>))
        {
