...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject2 :  IEquatable<InlineObject2>, IValidatableObject
    {
        ...
        public InlineObject2(string description = default(string), List<int> documents = default(List<int>), List<int> completedDocuments = default(List<int>), List<int> reviewers = default(List<int>))
        {
