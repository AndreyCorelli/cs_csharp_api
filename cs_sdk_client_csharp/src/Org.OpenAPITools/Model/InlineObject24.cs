...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject24 :  IEquatable<InlineObject24>, IValidatableObject
    {
        ...
        /// <param name="url">Menu item name..</param>
        /// <param name="group">group.</param>
        /// <param name="_public">_public.</param>
        /// <param name="order">order.</param>
        public InlineObject24(string name = default(string), string url = default(string), int? group = default(int?), bool _public = default(bool), int order = default(int))
        {
            this.Group = group;
            this.Name = name;
            this.Url = url;
