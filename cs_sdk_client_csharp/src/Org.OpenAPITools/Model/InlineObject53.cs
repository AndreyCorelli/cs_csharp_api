...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject53 :  IEquatable<InlineObject53>, IValidatableObject
    {
        ...
        public InlineObject53(string name = default(string), string documentType = default(string), int? project = default(int?), string statusName = default(string))
        {
            this.Name = name;
            ...
            if (statusName == null)
            {
                throw new InvalidDataException("statusName is a required property for InlineObject53 and cannot be null");
            }
            else
            {
