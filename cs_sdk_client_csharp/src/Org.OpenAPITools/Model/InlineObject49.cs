...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject49 :  IEquatable<InlineObject49>, IValidatableObject
    {
        ...
        public InlineObject49(string name = default(string), string code = default(string), int order = default(int), bool isActive = default(bool), bool isAccepted = default(bool), bool isRejected = default(bool))
        {
            this.Code = code;
            this.Name = name;
            this.Code = code;
