...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject59 :  IEquatable<InlineObject59>, IValidatableObject
    {
        ...
        public InlineObject59(int document = default(int), Object value = default(Object), string field = default(string), int? locationStart = default(int?), int? locationEnd = default(int?), string locationText = default(string), int? modifiedBy = default(int?))
        {
            // to ensure "document" is required (not null)
            if (document == null)
            {
                throw new InvalidDataException("document is a required property for InlineObject59 and cannot be null");
            }
            else
            {
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for InlineObject59 and cannot be null");
            }
            else
            {
                this.Value = value;
            ...
            if (field == null)
            {
                throw new InvalidDataException("field is a required property for InlineObject59 and cannot be null");
            }
            else
            {
                this.Field = field;
            ...
            {
                throw new InvalidDataException("locationStart is a required property for InlineObject59 and cannot be null");
            }
            else
            {
            ...
            if (locationEnd == null)
            {
                throw new InvalidDataException("locationEnd is a required property for InlineObject59 and cannot be null");
            }
            else
            {
