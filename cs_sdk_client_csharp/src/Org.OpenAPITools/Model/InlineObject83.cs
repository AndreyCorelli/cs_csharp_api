...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineObject83 :  IEquatable<InlineObject83>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject83" /> class.
        /// </summary>
        /// <param name="statusId">statusId.</param>
        /// <param name="all">all.</param>
        /// <param name="annotationIds">annotationIds.</param>
        /// <param name="noAnnotationIds">noAnnotationIds.</param>
        public InlineObject83(int? statusId = default(int?), bool all = default(bool), List<int> annotationIds = default(List<int>), List<int> noAnnotationIds = default(List<int>))
        {
        ...
        {
            return this.Equals(input as InlineObject83);
        }

        /// <summary>
        /// Returns true if InlineObject83 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineObject83 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineObject83 input)
        {
            if (input == null)
                return false;
