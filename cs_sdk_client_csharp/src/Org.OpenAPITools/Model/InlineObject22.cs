...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject22 :  IEquatable<InlineObject22>, IValidatableObject
    {
        ...
        public InlineObject22(string name = default(string), string url = default(string), int? group = default(int?), bool _public = default(bool), int order = default(int))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for InlineObject22 and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (url == null)
            {
                throw new InvalidDataException("url is a required property for InlineObject22 and cannot be null");
            }
            else
            {
                this.Url = url;
