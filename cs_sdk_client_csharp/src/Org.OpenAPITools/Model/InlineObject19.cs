...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject19 :  IEquatable<InlineObject19>, IValidatableObject
    {
        ...
        public InlineObject19(string name = default(string), bool _public = default(bool), int order = default(int))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for InlineObject19 and cannot be null");
            }
            else
            {
                this.Name = name;
