...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject23 :  IEquatable<InlineObject23>, IValidatableObject
    {
        ...
        public InlineObject23(string name = default(string), string url = default(string), int? group = default(int?), bool _public = default(bool), int order = default(int))
        {
            ...
            if (url == null)
            {
                throw new InvalidDataException("url is a required property for InlineObject23 and cannot be null");
            }
            else
            {
                this.Url = url;
