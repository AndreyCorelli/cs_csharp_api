...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject44 :  IEquatable<InlineObject44>, IValidatableObject
    {
        ...
        public InlineObject44(CategoryEnum? category = default(CategoryEnum?), string excludeRegexps = default(string), string definitionWords = default(string), string includeRegexps = default(string), bool regexpsPreProcessLower = default(bool), string detectedValue = default(string), ExtractionHintEnum? extractionHint = default(ExtractionHintEnum?), TextPartEnum? textPart = default(TextPartEnum?), string field = default(string))
        {
            ...
            if (field == null)
            {
                throw new InvalidDataException("field is a required property for InlineObject44 and cannot be null");
            }
            else
            {
                this.Field = field;
