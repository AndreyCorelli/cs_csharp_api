...
{
    /// <summary>
    /// ApiV1UsersUsersRoleData
    /// </summary>
    [DataContract]
    public partial class ApiV1UsersUsersRoleData :  IEquatable<ApiV1UsersUsersRoleData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1UsersUsersRoleData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ApiV1UsersUsersRoleData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1UsersUsersRoleData" /> class.
        /// </summary>
        ...
        public ApiV1UsersUsersRoleData(string name = default(string), string code = default(string), int order = default(int), bool isAdmin = default(bool), bool isTopManager = default(bool), bool isManager = default(bool))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ApiV1UsersUsersRoleData and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for ApiV1UsersUsersRoleData and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (order == null)
            {
                throw new InvalidDataException("order is a required property for ApiV1UsersUsersRoleData and cannot be null");
            }
            else
            {
                this.Order = order;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiV1UsersUsersRoleData {\n");
        ...
        {
            return this.Equals(input as ApiV1UsersUsersRoleData);
        }

        /// <summary>
        /// Returns true if ApiV1UsersUsersRoleData instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiV1UsersUsersRoleData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiV1UsersUsersRoleData input)
        {
            if (input == null)
                return false;
