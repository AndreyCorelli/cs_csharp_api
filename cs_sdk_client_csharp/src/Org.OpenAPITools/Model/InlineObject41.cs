...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject41 :  IEquatable<InlineObject41>, IValidatableObject
    {
        ...
        public InlineObject41(string documentType = default(string), string name = default(string), int order = default(int))
        {
            // to ensure "documentType" is required (not null)
            if (documentType == null)
            {
                throw new InvalidDataException("documentType is a required property for InlineObject41 and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for InlineObject41 and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (order == null)
            {
                throw new InvalidDataException("order is a required property for InlineObject41 and cannot be null");
            }
            else
            {
                this.Order = order;
