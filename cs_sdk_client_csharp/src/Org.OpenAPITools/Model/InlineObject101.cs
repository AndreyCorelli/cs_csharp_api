...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineObject101 :  IEquatable<InlineObject101>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject101" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineObject101() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject101" /> class.
        /// </summary>
        ...
        public InlineObject101(string fixture = default(string), string mode = default(string), string encoding = default(string))
        {
            // to ensure "fixture" is required (not null)
            if (fixture == null)
            {
                throw new InvalidDataException("fixture is a required property for InlineObject101 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as InlineObject101);
        }

        /// <summary>
        /// Returns true if InlineObject101 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineObject101 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineObject101 input)
        {
            if (input == null)
                return false;
