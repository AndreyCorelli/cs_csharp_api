...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject7 :  IEquatable<InlineObject7>, IValidatableObject
    {
        ...
        public InlineObject7(string name = default(string), string description = default(string), int status = default(int), bool sendEmailNotification = default(bool), List<int> owners = default(List<int>), List<int> reviewers = default(List<int>), List<int> superReviewers = default(List<int>), string type = default(string), bool hideClauseReview = default(bool))
        {
