...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject25 :  IEquatable<InlineObject25>, IValidatableObject
    {
        ...
        public InlineObject25(string name = default(string), string documentType = default(string), int? project = default(int?), string statusName = default(string))
        {
            this.Name = name;
            ...
            if (statusName == null)
            {
                throw new InvalidDataException("statusName is a required property for InlineObject25 and cannot be null");
            }
            else
            {
