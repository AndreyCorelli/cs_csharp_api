...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject26 :  IEquatable<InlineObject26>, IValidatableObject
    {
        ...
        public InlineObject26(string name = default(string), string documentType = default(string), int? project = default(int?), string statusName = default(string))
        {
            this.Name = name;
            ...
            if (statusName == null)
            {
                throw new InvalidDataException("statusName is a required property for InlineObject26 and cannot be null");
            }
            else
            {
