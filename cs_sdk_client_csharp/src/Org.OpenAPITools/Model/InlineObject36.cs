...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject36 :  IEquatable<InlineObject36>, IValidatableObject
    {
        ...
        /// <param name="code">Field codes must be lowercase, should start with  a Latin letter, and contain only Latin letters, digits, underscores. Field codes must be unique to every Document Type..</param>
