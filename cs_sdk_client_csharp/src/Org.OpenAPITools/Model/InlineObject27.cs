...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject27 :  IEquatable<InlineObject27>, IValidatableObject
    {
        ...
        public InlineObject27(string name = default(string), string documentType = default(string), int fileSize = default(int), string folder = default(string), int? status = default(int?), ApiV1DocumentDocumentsIdStatusData statusData = default(ApiV1DocumentDocumentsIdStatusData), int? assignee = default(int?), DateTime? assignDate = default(DateTime?), ApiV1DocumentDocumentsIdAssigneeData assigneeData = default(ApiV1DocumentDocumentsIdAssigneeData), string description = default(string), string title = default(string), List<Object> notes = default(List<Object>))
        {
            this.Name = name;
