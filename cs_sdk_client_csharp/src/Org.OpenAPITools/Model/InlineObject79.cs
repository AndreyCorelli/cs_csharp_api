...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineObject79 :  IEquatable<InlineObject79>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject79" /> class.
        /// </summary>
        ...
        public InlineObject79(bool doNotUpdateModified = default(bool), bool doNotWrite = default(bool), List<int> documentIds = default(List<int>))
        {
        ...
        {
            return this.Equals(input as InlineObject79);
        }

        /// <summary>
        /// Returns true if InlineObject79 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineObject79 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineObject79 input)
        {
            if (input == null)
                return false;
