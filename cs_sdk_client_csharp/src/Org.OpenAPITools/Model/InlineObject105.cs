...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineObject105 :  IEquatable<InlineObject105>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject105" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineObject105() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject105" /> class.
        /// </summary>
        ...
        public InlineObject105(int document = default(int), string field = default(string), Object value = default(Object), int? locationStart = default(int?), int? locationEnd = default(int?), string locationText = default(string), int? modifiedBy = default(int?))
        {
            // to ensure "document" is required (not null)
            if (document == null)
            {
                throw new InvalidDataException("document is a required property for InlineObject105 and cannot be null");
            }
            else
            {
            ...
            if (field == null)
            {
                throw new InvalidDataException("field is a required property for InlineObject105 and cannot be null");
            }
            else
            {
                this.Field = field;
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for InlineObject105 and cannot be null");
            }
            else
            {
                this.Value = value;
            ...
            {
                throw new InvalidDataException("locationStart is a required property for InlineObject105 and cannot be null");
            }
            else
            {
            ...
            if (locationEnd == null)
            {
                throw new InvalidDataException("locationEnd is a required property for InlineObject105 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as InlineObject105);
        }

        /// <summary>
        /// Returns true if InlineObject105 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineObject105 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineObject105 input)
        {
            if (input == null)
                return false;
