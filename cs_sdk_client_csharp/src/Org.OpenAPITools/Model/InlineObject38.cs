...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject38 :  IEquatable<InlineObject38>, IValidatableObject
    {
        ...
        public InlineObject38(string title = default(string), string code = default(string), List<string> searchFields = default(List<string>), EditorTypeEnum? editorType = default(EditorTypeEnum?), Object fieldCodeAliases = default(Object), Object metadata = default(Object))
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for InlineObject38 and cannot be null");
            }
            else
            {
                this.Title = title;
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for InlineObject38 and cannot be null");
            }
            else
            {
                this.Code = code;
