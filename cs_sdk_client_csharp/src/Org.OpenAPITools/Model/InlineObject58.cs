...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject58 :  IEquatable<InlineObject58>, IValidatableObject
    {
        ...
        public InlineObject58(Object value = default(Object), int? locationStart = default(int?), int? locationEnd = default(int?), string locationText = default(string), int assigneeId = default(int), DateTime? assignDate = default(DateTime?), int statusId = default(int))
        {
            this.Value = value;
