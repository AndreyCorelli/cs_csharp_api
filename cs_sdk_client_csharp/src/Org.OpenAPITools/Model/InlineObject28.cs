...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject28 :  IEquatable<InlineObject28>, IValidatableObject
    {
        ...
        public InlineObject28(string name = default(string), string documentType = default(string), int? project = default(int?), string statusName = default(string))
        {
            this.Name = name;
            ...
            if (statusName == null)
            {
                throw new InvalidDataException("statusName is a required property for InlineObject28 and cannot be null");
            }
            else
            {
