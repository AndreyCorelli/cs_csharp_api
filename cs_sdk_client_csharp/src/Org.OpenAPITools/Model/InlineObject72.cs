...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineObject72 :  IEquatable<InlineObject72>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject72" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineObject72() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject72" /> class.
        /// </summary>
        ...
        public InlineObject72(string username = default(string), string email = default(string), string password1 = default(string), string password2 = default(string))
        {
            // to ensure "username" is required (not null)
            if (username == null)
            {
                throw new InvalidDataException("username is a required property for InlineObject72 and cannot be null");
            }
            else
            {
            ...
            if (email == null)
            {
                throw new InvalidDataException("email is a required property for InlineObject72 and cannot be null");
            }
            else
            {
                this.Email = email;
            ...
            if (password1 == null)
            {
                throw new InvalidDataException("password1 is a required property for InlineObject72 and cannot be null");
            }
            else
            {
            ...
            if (password2 == null)
            {
                throw new InvalidDataException("password2 is a required property for InlineObject72 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as InlineObject72);
        }

        /// <summary>
        /// Returns true if InlineObject72 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineObject72 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineObject72 input)
        {
            if (input == null)
                return false;
