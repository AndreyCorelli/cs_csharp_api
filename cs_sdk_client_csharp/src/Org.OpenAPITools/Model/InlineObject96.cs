...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineObject96 :  IEquatable<InlineObject96>, IValidatableObject
    {
        /// <summary>
        /// Defines EditorType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject96" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineObject96() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject96" /> class.
        /// </summary>
        ...
        public InlineObject96(string title = default(string), string code = default(string), List<string> searchFields = default(List<string>), EditorTypeEnum? editorType = default(EditorTypeEnum?), ApiV1DocumentDocumentsIdAssigneeData createdBy = default(ApiV1DocumentDocumentsIdAssigneeData), ApiV1DocumentDocumentsIdAssigneeData modifiedBy = default(ApiV1DocumentDocumentsIdAssigneeData), Object metadata = default(Object), int fieldsNumber = default(int))
        {
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for InlineObject96 and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (createdBy == null)
            {
                throw new InvalidDataException("createdBy is a required property for InlineObject96 and cannot be null");
            }
            else
            {
            ...
            if (modifiedBy == null)
            {
                throw new InvalidDataException("modifiedBy is a required property for InlineObject96 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fieldsNumber is a required property for InlineObject96 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as InlineObject96);
        }

        /// <summary>
        /// Returns true if InlineObject96 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineObject96 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineObject96 input)
        {
            if (input == null)
                return false;
